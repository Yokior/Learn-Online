...
<#--                                            <li><a href="http://127.0.0.1/course/preview/learning.html?id=${model.courseBase.id}&chapter=${secondNode.teachplanMedia.teachplanId!''}" target="_blank">${secondNode.pname}</a></li>-->
                                            <li><a href="http://127.0.0.1"></a></li>
                                        </#list>
                                    </ul>
                                </div>
                            </div>
